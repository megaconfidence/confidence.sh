...
<div class="youtube-embed"><iframe src="https://www.youtube.com/embed/soRQfAdJHVc" title="YouTube video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="aspect-ratio:16/9;width:100%;"></iframe></div>
...
![Registration/sign-up flow](./registration.webp)
...
![Authentication/sign-in flow](./authentication.webp)
...
![Testing registration](./registration.gif)
...
![Testing authentication](./authentication.gif)
