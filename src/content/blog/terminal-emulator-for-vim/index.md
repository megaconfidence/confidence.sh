...
![Compiling a Rust project within Vim’s terminal with  `:ter cargo build --release`](./built-in-terminal.webp)
...
![A floating terminal with Toggle Term](./toggleterm.webp)
...
<div class="youtube-embed"><iframe src="https://www.youtube.com/embed/wP0OXL2TgD8" title="YouTube video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="aspect-ratio:16/9;width:100%;"></iframe></div>
